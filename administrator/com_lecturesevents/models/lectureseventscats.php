...
class LecturesEventsCpModelLecturesEventsCats extends JModelList
{
	...
	protected function getListQuery()
	{
		...
		. ' LEFT JOIN #__lecturesevents_categories AS cc ON cc.id = a.parent_id'
		. ' LEFT JOIN #__lecturesevents_votes_statistics AS v ON v.catid = a.id'
		...
		*/
		...
		$query->from('`#__lecturesevents_categories` AS a');
		...
		$query->join('LEFT', '#__lecturesevents_categories AS c ON c.id = a.parent_id');
