...
class LecturesEventsCpModelLecturesEventsManager extends JModelAdmin {
    ...
    public function getForm($data = array(), $loadData = true) {
        ...
        $form = $this->loadForm('com_lecturesevents.lectureseventsmanager', 'lectureseventsmanager', array('control' => 'jform', 'load_data' => $loadData));
        if (empty($form)) {
            return false;
        }
        return $form;
    ...
    protected function loadFormData() {
        ...
        $data = JFactory::getApplication()->getUserState('com_lectureseventsm.edit.lectureseventsm.data', array());
    ...
    function getList() {
        ...
        $path = LecturesEventsHelper::getPathSet($manager);
