...
class LecturesEventsCpModelLecturesEventsCases extends JModelList
{
	...
	protected function getListQuery()
	{
		...
		$query->from('#__lecturesevents AS a');
		...
		$query->join('LEFT', '#__lecturesevents_categories AS c ON c.id = a.catid');
...
//                echo $db->replacePrefix($query);exit;
