...
echo '<div id="lecturesevents-upload">';
...
echo $this->tmpl['su_output']
	.'</fieldset>';
echo '</form>';	 
echo LecturesEventsFileUpload::renderCreateFolder($this->session->getName(), $this->session->getId(), $this->currentFolder, 'lectureseventsmanager', 'manager='.$this->manager.'&amp;tab='.$this->tmpl['currenttab']['upload'].'&amp;field='. $this->field );
echo '</div>';