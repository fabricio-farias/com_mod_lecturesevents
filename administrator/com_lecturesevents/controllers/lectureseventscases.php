...
class LecturesEventsCpControllerLecturesEventsCases extends JControllerAdmin
{
	...
	public function &getModel($name = 'LecturesEventsCase', $prefix = 'LecturesEventsCpModel')
	{
