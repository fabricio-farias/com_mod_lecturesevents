...
class TableLecturesEvents extends JTable
{

	function __construct(& $db) {
		parent::__construct('#__lecturesevents', 'id', $db);
	}
	
	function check()
	{
		if(empty($this->title)) {
			$this->title = LecturesEventsHelper::getTitleFromFilenameWithoutExt($this->filename);
		}
